...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EI_WRAPPER_DATA_BUF_SIZE, 2500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EI_WRAPPER_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_PEAK_DETECT_MODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_ACTIVITY_THRESHOLD, 500);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_INACTIVITY_THRESHOLD, 400);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_ACTIVITY_TIME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_INACTIVITY_TIME, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_REFERENCED_ACTIVITY_DETECTION_MODE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADXL372_TRIGGER_NONE, 1);
