...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_UART_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_UART_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_CDC_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_CDC_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_CDC_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_MSC_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_MSC_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_MSC_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_BLE_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_BLE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_BLE_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_POWER_MGMT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_POWER_MGMT_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_BUF_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BRIDGE_UART_BUF_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 16);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_APP_EVENT_MANAGER_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_UARTE1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DISK_RAM_VOLUME_SIZE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_RTT_MESSAGE_SIZE, 128);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x9100);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_RINGBUF_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_MASS_STORAGE_LOG_LEVEL, 3);
